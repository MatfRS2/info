...
namespace Prodavnica.Infrastructure.TagHelpers
{
    ...
    public class PageLinkTagHelpers : TagHelper
    {
        ...
        /* Ovaj deo je zbog stilizovanja. */
        public string KlasaElementa { get; set; }
        public string KlasaElementaNormalno { get; set; }
        public string KlasaElementaSelektovano { get; set; }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            for(int i =1; i<= ModelStrane.BrojStrana; i++)
            {
                ...
                /* Ovaj deo je zbog stilizovanja. */
                tag.AddCssClass(KlasaElementa);
                tag.AddCssClass(i == ModelStrane.TrenutnaStrana ?
                    KlasaElementaSelektovano : KlasaElementaNormalno);
