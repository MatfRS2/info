...
namespace Prodavnica.Controllers
{
    ...
    {
        /* Omogucava pristup korisnicima.
         * 
         * Malo sire objasnjenje (poredimo sa onim sto smo mi pravili ranije): 
         * Kad smo kreirali Proizvod,
         * kreirali smo AppDbContext za vezu sa EF Core i kreirali smo
         * EFRepozitorijum koji vraca niz svih proizvoda (i ima jos neke funkcionalnosti).
         * Slicno je i ovde. Imamo MojKorisnik, imamo AppIdentityDbContext,
         * a UserManager je ugradjen i ne moramo da ga pravimo.
         * UserManager zapravo odgovara onome sto je EFRepozitorijum (odnosno IProizvodRepozitorijum).
         */
        private UserManager<MojKorisnik> userManager;

        /* Omogucava korisnicima prijavljivanje.
         */
