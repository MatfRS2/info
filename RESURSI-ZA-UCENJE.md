...
* Књиге и упутства за Софтверско инжењерство и управљање пројектима  
  ...
  * McCormic S.: [AntiPatterns: Refactoring Software, Architectures, and Projects in Crisis](http://antipatterns.com/briefing/index.htm){:target="_blank"} - Willey, 1998.
...
* Књиге и упутства за Агилну методологију развоја софтвера  
...
* Елементи СУБП Microsoft SQL Server
