    ...
    public class ProizvodControllerTest{
        ...
        */
        ...
        SpisakProizvodaViewModel rezultat = 
            controller.SpisakProizvoda(null, 2).ViewData.Model as SpisakProizvodaViewModel;
        ...
        mock.Setup(m => m.Proizvodi).Returns((new Proizvod [] {
            new Proizvod {ProizvodID = 1, Ime = "Proizvod1", Kategorija = "Kat1"},
        ...
        //When
        SpisakProizvodaViewModel rezultat = 
            controller.SpisakProizvoda("Kat2", 1).ViewData.Model as SpisakProizvodaViewModel;
        
        //Then
        Proizvod[] prod = rezultat.Proizvodi.ToArray();
        Assert.True(prod.Length == 2);
        Assert.Equal(prod[0].Ime, "Proizvod2");
        Assert.Equal(prod[1].Ime, "Proizvod4");
        }
